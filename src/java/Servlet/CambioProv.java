...
public class CambioProv extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
	...
	sentencia=conexion.createStatement();
        String a=req.getParameter("usuario");
        String c=req.getParameter("pass");
	//Cogemos todos los datos de la asignaturas
	int n=sentencia.executeUpdate("update tblProveedor set pass='"+c+"' where usuario='"+a+"'"); 
