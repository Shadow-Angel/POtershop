...
"select  tblproducto.producto, cantidad,tblproducto.precio, tblproveedor.proveedor from carrito\n" +
...
public class IniciaProveedor extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
    ...
    String usuario="root";
    String clave="n0m3l0";
    String prov = req.getParameter("usuario");
...
"where proveedor = '"+prov+"';");
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ConsultaProducto</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>SISTEMA DE VENTAS</h1>");
            out.println("<table border=" + "0>");
            out.println("<thead>");
            out.println("<tr>");
            out.println("<th>PRODUCTOS</th>");

                out.println("</tr>");
            out.println("</thead>");
            out.println("<tbody>");
               out.println(" <tr>");
            out.println("<td><a href=" + "CambioProv" + ">Modificar contraseña" + "</a></td>");
            out.println("<td><a href=" + "Elim.jsp" + ">Eliminar" + "</a></td>");
            out.println("</tr>");
            out.println("</tbody>");
            out.println("</table>");
	...
	while(resultados.next()) { 
	   ...
	   out.println(resultados.getString("cantidad"));
        ...
        out.println("<br>");
        out.println("<br>");
        out.println("<td><a href=" + "cerrarsesion.jsp" + "><button>Cerrar session" + "</button></a></td>");
	/*//Mostramos las distintas asignaturas
	while(resultados.next()) { 
