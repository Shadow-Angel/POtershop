...
public class Dulces extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
	...
	resultados=sentencia.executeQuery("SELECT * FROM tblProducto where idTPr=6");

	//Escribimos la cabecera de la página
	out.println("<html>\n <body>\n <h1>Productos</h1>");
        out.println("<td><h2>Dulces</h2></td>");
        out.println("<br><br><form method="+"get"+ " action="+"Carrito.jsp"+">");
