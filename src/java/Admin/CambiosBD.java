...
public class CambiosBD extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
	...
	sentencia=conexion.createStatement();
        ...
        String b=req.getParameter("producto");
        String c=req.getParameter("precio");
	//Cogemos todos los datos de la asignaturas
	int n=sentencia.executeUpdate("update tblProducto set producto='"+b+"',precio="+c+" where idProd="+a+""); 
