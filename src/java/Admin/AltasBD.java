...
public class AltasBD extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
	...
	sentencia=conexion.createStatement();
        String a=req.getParameter("producto");
        String b=req.getParameter("precio");
        String c=req.getParameter("idTPr");
        String d=req.getParameter("idProv");

	//Cogemos todos los datos de la asignaturas
	int n=sentencia.executeUpdate("insert into tblProducto (idProd,producto,precio,idTPr,idProv) values (null,'"+a+"',"+b+","+c+","+d+")");
